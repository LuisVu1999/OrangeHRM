...
class LeavePage(BasePage):
    ...
    def add_entitlement(self, add_entitlement_title: str, employee_name: str, duration: str, successfully_message: str):
        ...
        self.assert_text(LeaveLocator.ADD_ENTITLEMENT_TITLE, add_entitlement_title)
        self.assert_is_selected(LeaveLocator.INVIDUAL_EMPLOYEE)
    ...
    def apply_leave(self, apply_leave_title: str, date_time: str, leave_balance: str, successfully_message: str):
        ...
        self.assert_text_contain(LeaveLocator.LEAVE_BALANCE, leave_balance)
        self.click(LeaveLocator.SAVE_BUTTON)
        self.assert_text_contain(LeaveLocator.NOTIFY_MESSAGE, successfully_message)
    ...
    def approve_leave(self, employee_name: str, date_approve: str, leave_type: str, balance: str, 
        ...
        self.click(LeaveLocator.SAVE_BUTTON)
        self.wait_thread_sleep(2)
        self.assert_text(LeaveLocator.DATE_APPROVE, date_approve)
        self.assert_text(LeaveLocator.EMPLOYEE_APPROVE, employee_name)
        self.assert_text(LeaveLocator.LEAVE_TYPE_APPROVE, leave_type)
        self.assert_text(LeaveLocator.LEAVE_BALANCE_APPROVE, balance)
        self.assert_text(LeaveLocator.NUMBER_DAYS_APPROVE, number_day)
        self.assert_text(LeaveLocator.STATUS_APPROVE, status)
