...
class AdminPage(BasePage):
    ...
    def view_user(self, user_name: str, role_expected: str, expected_employee_name: str, expected_status: str):
        ...
        self.assert_text(AdminLocator.VERIFY_ROLE, role_expected, "view role")
        self.assert_text(AdminLocator.VERIFY_EMPLOYEE_NAME, expected_employee_name, "view emp name")
        self.assert_text(AdminLocator.VERIFY_STATUS, expected_status, "view status")
        self.assert_visible(AdminLocator.VERIFY_ACTION_EDIT, "view edit button")
        self.assert_visible(AdminLocator.VERIFY_ACTION_DELETE, "view delete button")
